...
@Service
public class MnrlReactivatedDataServiceV2 {

	private static final Logger LOGGER = LoggerFactory.getLogger(MnrlReactivatedDataServiceV2.class);
	...
	public String getMnrlReactivatedData(MnrlReactivatedDataRequestV2 mnrlReactivatedDataRequest) throws ClientProtocolException, JSONException,
