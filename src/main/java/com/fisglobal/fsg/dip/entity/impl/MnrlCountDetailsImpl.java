...
@Repository
public class MnrlCountDetailsImpl {

	private static final Logger LOGGER = LoggerFactory.getLogger(MnrlCountDetailsImpl.class);
	...
	public List<MnrlCountDetails_DAO> getMnrlCountData(String fetchDate, String status, LocalDate date) {
		List<MnrlCountDetails_DAO> suspdtslDaoObj = null;
		CriteriaBuilder cb = null;
		CriteriaQuery<MnrlCountDetails_DAO> cq = null;
		Root<MnrlCountDetails_DAO> rootCrtObj = null;
		List<Predicate> predicates = null;
		try {
			cb = em.getCriteriaBuilder();
			cq = cb.createQuery(MnrlCountDetails_DAO.class);
			rootCrtObj = cq.from(MnrlCountDetails_DAO.class);
