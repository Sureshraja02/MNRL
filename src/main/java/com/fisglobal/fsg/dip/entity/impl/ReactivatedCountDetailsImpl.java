...
@Repository
public class ReactivatedCountDetailsImpl {

	private static final Logger LOGGER = LoggerFactory.getLogger(ReactivatedCountDetailsImpl.class);

	@PersistenceContext
	EntityManager em;

	/*
	 * public MnrlCountDetails_DAO getMaxFetchDate() { MnrlCountDetails_DAO
	 * suspdtslDaoObj = null; CriteriaBuilder cb = null;
	 * CriteriaQuery<MnrlCountDetails_DAO> cq = null; Root<MnrlCountDetails_DAO>
	 * rootCrtObj = null; List<Predicate> predicates = null; try { cb =
	 * em.getCriteriaBuilder(); cq = cb.createQuery(MnrlCountDetails_DAO.class);
	 * rootCrtObj = cq.from(MnrlCountDetails_DAO.class); predicates = new
	 * ArrayList<Predicate>();
	 * 
	 * cq.select(cb.greatest(rootCrtObj.get("fetchDate")));
	 * cq.where(predicates.toArray(new Predicate[] {}));
	 * TypedQuery<MnrlCountDetails_DAO> query = em.createQuery(cq);
	 * 
	...
	public List<ReactivatedCountDetails_DAO> getReactivatedCountData(String fetchDate, String status, LocalDate date) {
		List<ReactivatedCountDetails_DAO> suspdtslDaoObj = null;
		CriteriaBuilder cb = null;
		CriteriaQuery<ReactivatedCountDetails_DAO> cq = null;
		Root<ReactivatedCountDetails_DAO> rootCrtObj = null;
		List<Predicate> predicates = null;
		try {
			cb = em.getCriteriaBuilder();
			cq = cb.createQuery(ReactivatedCountDetails_DAO.class);
			rootCrtObj = cq.from(ReactivatedCountDetails_DAO.class);
			...
			TypedQuery<ReactivatedCountDetails_DAO> query = em.createQuery(cq);
